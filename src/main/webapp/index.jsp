...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=75fab7aa29c4b6b3c0b3ade35a4bd975"></script>
            ...
            <div class="container px-5 " id="sticky-wrapper" class="sticky-wrapper">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link" href="/admin/admindummy.jsp">Admin</a></li>
                    ...
                    <div class="col-lg-10 col-xl-7">
                        <div class="text-center">
                            <div class="fs-5 mb-4 fst-italic ">
                                "고객 여러분들의 운동을 위해 전문적인 프로그램과 <br>회원 간 정보 교환 및 운동용품 구매를 <br>케이 헬스에서 제공해 드리며<br>
                                고객 여러분께 성심성의를 다해 도와드립니다."</div>
                            <div class="d-flex align-items-center justify-content-center">
                                <img class="rounded-circle me-3" src="https://dummyimage.com/40x40/ced4da/6c757d"
                                    alt="..." />
                                <div class="fw-bold">
                                    임근혁
                                    <span class="fw-bold text-primary mx-1">/</span> CEO,
                                    K-Health
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="#!">
                                    <h5 class="card-title mb-3">Another blog
                                        post title</h5>
                                </a>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="#!">
                                    <h5 class="card-title mb-3">The last blog
                                        post title is a little bit longer than the others</h5>
                                </a>
                        ...
                        <div class="row gx-5">
                            <div class="col-lg-7 mb-5 mb-lg-0">
                                ...
                                <script>
                                    ...
                                    var markerPosition = new kakao.maps.LatLng(37.5679067, 126.9830668);
