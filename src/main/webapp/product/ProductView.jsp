          ...
          <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
              <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-md-6">
                  <img class="card-img-top mb-5 mb-md-0" src="/image/${oriName }" alt="..." />
                </div>
                ...
                <div class="col-md-6">
                  ...
                  <div >
                    ...
                    <div class="row mb-2">
                      <div class="col">
                        <input type="number" name="amount" style="max-width: 3rem" value="1">
...
<!--                         <input type="button" value="-" onClick="javascript:this.form.amount.value--;"> -->
                    ...
                    <div class="row">
                      <div class="col">
                        <input type="button" class="btn btn-outline-dark flex-shrink-0" id="buy" value="구매하기">
                        <button class="btn btn-outline-dark flex-shrink-0 me-1" type="button" id="addwishlist">
